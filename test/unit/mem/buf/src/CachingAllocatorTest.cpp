...
namespace
{
    //! A minimal wrapper adapting cub::CachingDeviceAllocator to alpaka's alpaka::concepts::CachingAllocator
    //! interface.
    ...
    static_assert(alpaka::concepts::CachingAllocator<AllocatorWrapper>);
} // namespace
